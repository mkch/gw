...
// MsgListenerKey represents a message listener added by [Window.AddMsgListener].
...
// Window is the base interface for all windows and controls created and attached in this package.
...
// Window is the base interface for all windows and controls created in this package.
...
// Only [Window] instances initialized by this function can be retrieved by [LookupWindow].
// One can wrap an uninitialized [Window] instance to crate a new window type, and then call this
// function to initialize the instance of the new type. See Wrapper example for details.
func Init[T Window](window T) T {
	if window.Valid() {
