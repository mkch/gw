...
const (
	SS_LEFT            win32.WindowStyle = 0x00000000
	SS_CENTER          win32.WindowStyle = 0x00000001
	SS_RIGHT           win32.WindowStyle = 0x00000002
	SS_ICON            win32.WindowStyle = 0x00000003
	SS_BLACKRECT       win32.WindowStyle = 0x00000004
	SS_GRAYRECT        win32.WindowStyle = 0x00000005
	SS_WHITERECT       win32.WindowStyle = 0x00000006
	SS_BLACKFRAME      win32.WindowStyle = 0x00000007
	SS_GRAYFRAME       win32.WindowStyle = 0x00000008
	SS_WHITEFRAME      win32.WindowStyle = 0x00000009
	SS_USERITEM        win32.WindowStyle = 0x0000000A
	SS_SIMPLE          win32.WindowStyle = 0x0000000B
	SS_LEFTNOWORDWRAP  win32.WindowStyle = 0x0000000C
	SS_OWNERDRAW       win32.WindowStyle = 0x0000000D
	SS_BITMAP          win32.WindowStyle = 0x0000000E
	SS_ENHMETAFILE     win32.WindowStyle = 0x0000000F
	SS_ETCHEDHORZ      win32.WindowStyle = 0x00000010
	SS_ETCHEDVERT      win32.WindowStyle = 0x00000011
	SS_ETCHEDFRAME     win32.WindowStyle = 0x00000012
	SS_TYPEMASK        win32.WindowStyle = 0x0000001F
	SS_REALSIZECONTROL win32.WindowStyle = 0x00000040
	SS_NOPREFIX        win32.WindowStyle = 0x00000080
	SS_NOTIFY          win32.WindowStyle = 0x00000100
	SS_CENTERIMAGE     win32.WindowStyle = 0x00000200
	SS_RIGHTJUST       win32.WindowStyle = 0x00000400
	SS_REALSIZEIMAGE   win32.WindowStyle = 0x00000800
	SS_SUNKEN          win32.WindowStyle = 0x00001000
	SS_EDITCONTROL     win32.WindowStyle = 0x00002000
	SS_ENDELLIPSIS     win32.WindowStyle = 0x00004000
	SS_PATHELLIPSIS    win32.WindowStyle = 0x00008000
	SS_WORDELLIPSIS    win32.WindowStyle = 0x0000C000
	SS_ELLIPSISMASK    win32.WindowStyle = 0x0000C000
)
...
func (s *Static) CreateHandle() (win32.HWND, error) {
	...
	return win32util.CreateWindow(&win32util.Wnd{
		...
		X:          metrics.ToPx(s.Spec.X, dpi).Value(),
		Y:          metrics.ToPx(s.Spec.Y, dpi).Value(),
		Width:      metrics.ToPx(s.Spec.Width, dpi).Value(),
		Height:     metrics.ToPx(s.Spec.Height, dpi).Value(),
