...
const (
	...
	LANG_BOSNIAN_NEUTRAL     LANGID_PRIMARY = 0x781a // Use with the ConvertDefaultLocale function
	...
	LANG_CHINESE_TRADITIONAL LANGID_PRIMARY = 0x7c04 // Use with the ConvertDefaultLocale function
	...
	LANG_SERBIAN_NEUTRAL     LANGID_PRIMARY = 0x7c1a // Use with the ConvertDefaultLocale function
...
func MAKELANGID(p LANGID_PRIMARY, s LANGID_SUB) LANGID {
	return LANGID(uint32(p) | uint32(s)<<10)
}
